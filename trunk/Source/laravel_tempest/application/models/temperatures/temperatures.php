...
*/
	public static function get_all()
	{
		try
		{
			$temperatures = DB::table('temperatures')->take(1000)->get();	//gets newest 1000 (getting all takes more memory than is allowed)
			//$temperatures = DB::table('temperatures')->get();		//gets all (bad idea!)
			return $temperatures;
		}
